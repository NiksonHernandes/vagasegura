...
class Ion_auth_model extends CI_Model
{
	...
	public function __construct()
	{
		...
		{
			//Especifica o nome do grupo, abre uma nova conexão específica
		...
		//Carrega os deminitiadores de erro
	...
	public function register($identity, $password, $email, $additional_data = [], $groups = [])
	{
		...
		// Checa as configurações default do banco de dados

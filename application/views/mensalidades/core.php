            ...
            <div class="main-content">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            ...
                            <?php else: ?>
                                <a title="Cadastrar mensalidade" href="javascript:void(0)" class="btn btn btn-success mr-2" data-toggle="modal" data-target="#mensalidade">Salvar</i></a>                            
                            <?php endif; ?>
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <p></p>
                                            Clique em <span class="text-success font-weight-bold">"Sim"</span> para salvar.
                                        </div>

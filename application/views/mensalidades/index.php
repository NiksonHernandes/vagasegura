    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-header d-block">
                <a class="btn bg-green float-right text-white" data-toggle="tooltip" data-placement="right" title="Cadastrar <?php echo $this->router->fetch_class(); ?>"
                href="<?php echo base_url($this->router->fetch_class().'/core/'); ?>"> <i class="fas fa-plus"></i>Nova mensalidade</a>
            </div>
                    ...
                    <tbody>
                        <?php foreach ($mensalidades as $mensalidade) : ?>
                            <tr>
                                ...
                                <td><i class="fas fa-eye text-yellow"></i>&nbsp;<a data-toggle="tooltip" data-placement="bottom" title="Visualizar mensalista <?php echo $mensalidade->mensalista_nome ; ?>" href="<?php echo base_url('mensalistas/core/'.$mensalidade->mensalidade_id); ?> "><?php echo $mensalidade->mensalista_nome ; ?></a> </td>
                                ...
                                <td>
                                    <div class="text-right">
                                        <a data-toggle="tooltip" data-placement="bottom" title="<?php echo($mensalidade->mensalidade_status == 1 ? 'Visualizar' : 'Editar' )?> <?php echo $this->router->fetch_class(); ?>" href="<?php echo base_url($this->router->fetch_class().'/core/'. $mensalidade->mensalidade_id); ?>" class="btn btn-icon btn-primary">
                                            <i class="<?php echo ($mensalidade->mensalidade_status == 1 ? 'ik ik-eye': 'fas fa-edit')?>"></i>
                                        </a>
                                        <button type="button"  class="btn btn-icon btn-danger" data-toggle="modal" data-target="#mensalidade-<?php echo $mensalidade->mensalidade_id; ?>"><i class="fas fa-trash"></i>
                                        </button> 
                                    </div>
                                </td>
                            </tr>

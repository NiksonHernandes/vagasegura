            ...
            <div class="main-content">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                <div class="card-header d-block"><h3><a data-toggle="tooltip" data-placement="right" title="Cadastrar <?php echo $this->router->fetch_class(); ?>"class="btn bg-green text-white float-right" href="<?php echo base_url($this->router->fetch_class() . '/core/'); ?>">&nbsp;<i class="fas fa-plus"></i>Novo mensalista</a></h3></div>                                          
                                    <div class="card-body">
                                        ...
                                        <table class="table data-table table-md pl-10 pr-10">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    ?>" href="<?php echo base_url($this->router->fetch_class() . '/core/' . $mensalista->mensalista_id); ?>" class="btn btn-icon btn-primary"> <i class="fas fa-edit"></i></a>
                                                    <button type="button" title="Excluir <?php echo $this->router->fetch_class(); ?>" class="btn btn-icon btn-danger"data-toggle="modal" data-target="#mensalista-<?php echo $mensalista->mensalista_id; ?>"> <i class="fas fa-trash"></i></button>

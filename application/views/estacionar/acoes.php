                        ...
                        <div class="page-header">
                            <div class="row align-items-end">
                                <div class="col-lg-8">
                                    ...
                                    <i class="<?php echo $icone_view; ?> bg-inverse"></i>
                                        <div class="d-inline">
                                ...
                                <div class="card comp-card">
                                    <div class="card-body">
                                        <div class="row align-items-center">
                                            <div class="col">
                                                <h6 class="mb-25">Imprimir o ticket</h6>
                            ...
                            <div class="col-xl-4 col-md-6">
                                <div class="card comp-card">
                                    <div class="card-body">
                                        <div class="row align-items-center">
                                            <div class="col">
                                            <h6 class="mb-25">Listar os tickets</h6>
                                            <a class="btn bg-yellow text-white" href="<?php echo base_url($this->router->fetch_class()); ?>">Listar</a>
                                            </div>
                                            <div class="col-auto">
                                                <i class="fas fa-list-ol bg-yellow"></i>
                                            </div>
                                        </div>
                                    </div>
                                </div>

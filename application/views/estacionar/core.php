...
<div class="row mb-3">
    ...
    <div class="col-md-4 mb-3">
        ...
        <input placeholder="Insira a placa do veículo "  type="text" class="form-control placa" name="estacionar_placa_veiculo" value="<?php echo (isset($estacionado) ? $estacionado->estacionar_placa_veiculo : set_value('estacionar_placa_veiculo')) ?>" <?php echo (isset($estacionado) ? 'readonly' : '') ?>>
        <?php echo form_error('estacionar_placa_veiculo', '<div class="text-danger">', '</div>') ?>
    </div>

    <div class="col-md-4 mb-3">
        <label for="">Marca veículo</label>
        <input placeholder="Insira a marca do veículo"  type="text" class="form-control" name="estacionar_marca_veiculo" value="<?php echo (isset($estacionado) ? $estacionado->estacionar_marca_veiculo : set_value('estacionar_marca_veiculo')) ?>" <?php echo (isset($estacionado) ? 'readonly' : '') ?>>
        <?php echo form_error('estacionar_marca_veiculo', '<div class="text-danger">', '</div>') ?>
    </div>

    <div class="col-md-4 mb-3">
        <label for="">Modelo veículo</label>
        <input placeholder="Insira o modelo do veículo"  type="text" class="form-control" name="estacionar_modelo_veiculo" value="<?php echo (isset($estacionado) ? $estacionado->estacionar_modelo_veiculo : set_value('estacionar_modelo_veiculo')) ?>" <?php echo (isset($estacionado) ? 'readonly' : '') ?>>
...
<div class="">
    ...
    <?php else: ?>
        <a title="Cadastrar ordem de estacionamento" href="javascript:void(0)" class="btn btn btn-success mr-2" data-toggle="modal" data-target="#cadastrar">Salvar</i></a>                            
    <?php endif; ?>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p></p>
                Clique em <span class="text-success font-weight-bold">"Sim"</span> para prosseguir.
            </div>

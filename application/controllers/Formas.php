...
class Formas extends CI_Controller
{
    ...
    public function index() {
        ...
        $data = array(
            ...
            'sub_titulo' => 'Aqui poderá ver uma lista de formas de pagamento para o sistema',
            'icone_view' => 'fas fa-money-bill-alt',
            'styles' => array(
    ...
    public function core($forma_pagamento_id = NULL) {
        ...
        redirect($this->router->fetch_class());
         ...
         $data = array(
          ...
          'sub_titulo' => 'Aqui poderá cadastrar novas formas de pagamento',
          'icone_view' => 'fas fa-money-bill-alt',
          'styles' => array(
          'plugins/datatables.net-bs4/css/dataTables.bootstrap4.min.css',
           ),
          ...
          'plugins/datatables.net/js/estacionamento.js',
           ...
           $data = array(
            ...
            'sub_titulo' => 'Aqui poderá editar as formas de pagamento existentes',
            'icone_view' => 'fas fa-money-bill-alt',
            'styles' => array(
            'plugins/datatables.net-bs4/css/dataTables.bootstrap4.min.css',
             ),

...
class Sistema extends CI_Controller{
    ...
    public function __construct(){
      ...
      if(!$this->ion_auth->logged_in()){
        ...
        $this->session->set_flashdata('info', 'Não tem permissão para acessar esse menu SISTEMA, somente administradores!');
        redirect('/');
        }
    ...
    $this->form_validation->set_rules('sistema_texto_ticket', 'Texto do ticket', 'trim|max_length[200]');
  	...
  	if ($this->form_validation->run()) {
  		...
  		$data = array(
  			...
  			'sub_titulo' => 'Aqui você poderá editar as informações do sistema',
  			'icone_view' => 'fas fa-wrench',

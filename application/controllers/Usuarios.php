...
class Usuarios extends CI_Controller {
    ...
    public function index() {
        ...
        $this->session->set_flashdata('info', 'Não tem permissão para acessar esse menu USUÁRIOS, somente administradores!');
        redirect('/');
        }
        ...
        $data = array(
            ...
            'sub_titulo' => 'Aqui o poderá listar todos os usuários cadastrados no sistema',
               ...
               redirect('/');
                ...
                if ($this->form_validation->run()) {
                    ...
                    $data = array(
                        ...
                        'sub_titulo' => 'Aqui poderá cadastrar novos usuarios',
                ...
                if ($this->form_validation->run()) {
                   ...
                   // se nao foi passado a senha,não vai atualizar
                    ...
                    $data = array(
                        ...
                        'sub_titulo' => 'Aqui poderá editar os usuarios',
                        'icone_view' => 'ik ik-user',

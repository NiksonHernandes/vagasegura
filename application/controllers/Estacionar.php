...
class Estacionar extends CI_Controller
{
    ...
    public function index() {
        ...
        $data = array(
            ...
            'sub_titulo' => 'Aqui poderá listar todos os tickets cadastrados no estacionamento',
            'icone_view' => 'fas fa-car-side',
             'styles' => array(
        ...
        if (!$estacionar_id) {
           ...
           if ($this->form_validation->run()) {
               ...
               $data = array(
                   ...
                   'titulo' => 'Cadastrar ticket para veículos no estacionamento',
                   'sub_titulo' => 'Aqui poderá cadastrar novos tickets de veículos novos no estacionemento',
                   'icone_view' => 'fas fa-car-side',
                   'texto_modal' => 'Tem certeza que deseja salvar esses ticket? Não será possível alterá-lo',
                    'scripts' => array(
            ...
            if ($this->form_validation->run()) {
                ...
                $data = array(
                    ...
                    'titulo' => 'Encerrando ticket de estacionamento',
                    'sub_titulo' => 'Aqui poderá listar todos os tickets a ser fechados',
                    'icone_view' => 'fas fa-car-side',
                    'texto_modal' => 'Tem certeza que deseja encerrar esse ticket de estacionamento?',
                     'scripts' => array(
                        'plugins/mask/jquery.mask.min.js',
                        'plugins/mask/custom.js',
                        'js/estacionar/estacionar.js',

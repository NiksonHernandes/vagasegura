...
class Precificacoes extends CI_Controller
{
    ...
    public function index() {
        ...
        $data = array(
            ...
            'titulo' => 'Listar precificações cadastradas',
            'sub_titulo' => 'Aqui poderá encontrar todos os detalhes das precificações.',
    ...
    public function core($precificacao_id = NULL) {
         ...
         if ($this->form_validation->run()) {
             ...
             $data = array(
                 ...
                 'sub_titulo' => 'Aqui poderá cadastrar novas precificações.',
            ...
            if (!$this->core_model->get_by_id('precificacoes', array('precificacao_id' => $precificacao_id))) {
                ...
                if ($this->form_validation->run()) {
                    ...
                    $data = array(
                        ...
                        'sub_titulo' => 'Poderá editar os dados sobre os valores.',
                        'icone_view' => 'fas fa-pen-alt',
                        'scripts' => array(
                            'plugins/mask/jquery.mask.min.js',
                            'plugins/mask/custom.js'
                        ),

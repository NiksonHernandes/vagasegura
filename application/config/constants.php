...
defined('EXIT_ERROR')          OR define('EXIT_ERROR', 1); // erros genéricos
defined('EXIT_CONFIG')         OR define('EXIT_CONFIG', 3); // erro de config
defined('EXIT_UNKNOWN_FILE')   OR define('EXIT_UNKNOWN_FILE', 4); // arquivo não encontrado
defined('EXIT_UNKNOWN_CLASS')  OR define('EXIT_UNKNOWN_CLASS', 5); // class não encontrada
defined('EXIT_UNKNOWN_METHOD') OR define('EXIT_UNKNOWN_METHOD', 6); //membro da class n encontrado
defined('EXIT_USER_INPUT')     OR define('EXIT_USER_INPUT', 7); // entrada de usuário inválida
defined('EXIT_DATABASE')       OR define('EXIT_DATABASE', 8); // erro no BD
